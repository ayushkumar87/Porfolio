...
/**
 * Projects Component
 * Renders a grid of featured projects with tech tags and interactive external links.
 * Data is sourced from the 'projects' array in portfolio.js
 */
const Projects = () => {
                            ...
                            <div className="project-card-content">
                                ...
                                <div className="project-footer">
                                    ...
                                    <div className="project-links">
                                        <a href={project.githubLink} target="_blank" rel="noopener noreferrer" className="project-link" title="Source Code">
