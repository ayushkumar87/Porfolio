            ...
            <div className="container">
                ...
                <div className="contact-grid">
                    <a href={`mailto:${personal.email}`} className="contact-card">
                        ...
                        <p className="contact-info">{personal.email}</p>
                    </a>
                    <a href={`tel:${personal.phone}`} className="contact-card">
                        ...
                        <p className="contact-info">{personal.phone}</p>
                    </a>
                    <a href={personal.linkedin} target="_blank" rel="noopener noreferrer" className="contact-card">
                        ...
                        <p className="contact-info">linkedin.com/in/ayush-kumar</p>
                    </a>
                    <a href={personal.github} target="_blank" rel="noopener noreferrer" className="contact-card">
                        ...
                        <p className="contact-info">github.com/Ayush-Kumar</p>
                    </a>
                </div>
            </div>
        </section>
